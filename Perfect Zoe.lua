...
QCasted => Player.SpellBook.GetSpell(SpellSlot.Q).Name == "ZoeQRecast"
GameObject QMissile => GameObjects.Get<GameObject>().FirstOrDefault(x => x.Name == "Zoe_Base_Q_Mis_Linger")
GameObject Portal => GameObjects.Get<GameObject>().FirstOrDefault(x => x.Name == "Zoe_Base_R_portal_entrance")
